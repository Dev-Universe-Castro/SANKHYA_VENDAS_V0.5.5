...
export default function PedidoVendaFromLead({ dadosIniciais, onSuccess, onCancel }: PedidoVendaFromLeadProps) {
  ...
  useEffect(() => {
    ...
    // Verificar condição comercial por modelo se tiver modelo definido e não tiver parceiro ou complemento
    if (dadosIniciais.CODTIPOPER && !dadosIniciais.CODPARC) {
      verificarTipVendaPorModelo(dadosIniciais.CODTIPOPER)
    }
  }, [dadosIniciais])
